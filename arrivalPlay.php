...
<div class="speak">Announcing...</div>
	<?php
		...
		$id = $_GET['id'];
		$row = DB::queryFirstRow("SELECT * FROM arrival WHERE id=%i", $id);
		$al = $row['airline'];
		$ci = $row['origin'];
		...
		$ni = substr($fl,3,1);
		$san = substr($fl,4,1);
		$jam = substr($row['schedarrival'],11,2);
		$men = substr($row['schedarrival'],14,2);
	?>
	<script>
	var status = <?= $st ?>;
	var numb = <?= $k ?>;
	...
	if (status == 3){
		...
		mp[10] = fla[5];
		mp[11] = fla[6];	
		mp[12] = new Audio('/sounds/bahasa/dari.mp3');
		mp[13] = fla[14];
		mp[14] = fla[15];
		mp[15] = fla[16];
		mp[16] = new Audio('/sounds/bahasa/landed.mp3');
		...
		mp[20] = new Audio('/sounds/null.mp3');
		...
		mp[28] = fla[12];
		mp[29] = fla[13];
		mp[30] = new Audio('/sounds/english/dari.mp3');
		mp[31] = fla[17];
		mp[32] = fla[18];
		mp[33] = fla[19];
		mp[34] = new Audio('/sounds/english/landed.mp3');
		...
		mp[14] = fla[15];
		mp[15] = fla[16];
		mp[16] = new Audio('/sounds/bahasa/diverted.mp3');
		mp[17] = new Audio('/sounds/bahasa/thanks.mp3');
		mp[18] = new Audio('/sounds/60.mp3');
		mp[19] = new Audio('/sounds/english/perhatian.mp3');
		mp[20] = new Audio('/sounds/english/pesawat.mp3');
		...
		mp[32] = fla[18];
		mp[33] = fla[19];
		mp[34] = new Audio('/sounds/english/diverted.mp3');
		mp[35] = new Audio('/sounds/english/thanks.mp3');
		mp[36] = new Audio('/sounds/ending.mp3');
		...
		mp[14] = fla[15];
		mp[15] = fla[16];
		mp[16] = new Audio('/sounds/bahasa/delayarr.mp3');
		mp[17] = new Audio('/sounds/bahasa/<?= $jam ?>.mp3');
		mp[18] = new Audio('/sounds/bahasa/<?= $men ?>.mp3');
		mp[19] = new Audio('/sounds/bahasa/thanks.mp3');
		mp[20] = new Audio('/sounds/60.mp3');
		mp[21] = new Audio('/sounds/english/perhatian.mp3');
		mp[22] = new Audio('/sounds/english/pesawat.mp3');
		mp[23] = new Audio('/sounds/airlines/<?= $al ?>.mp3');
		mp[24] = fla[21];
		mp[25] = fla[7];	
		mp[26] = fla[8];	
		mp[27] = fla[9];	
		...
		mp[30] = fla[12];
		mp[31] = fla[13];
		mp[32] = new Audio('/sounds/english/dari.mp3');
		mp[33] = fla[17];
		mp[34] = fla[18];
		mp[35] = fla[19];
		mp[36] = new Audio('/sounds/english/delayarr.mp3');
		mp[37] = new Audio('/sounds/english/<?= $jam ?>.mp3');
		mp[38] = new Audio('/sounds/english/<?= $men ?>.mp3');
		mp[39] = new Audio('/sounds/english/thanks.mp3');
		mp[40] = new Audio('/sounds/ending.mp3');
	}
	...
	function playit(i){
		...
		mp[i].addEventListener('ended', function(){
			if ((skip == 1 && status != 3) && (i == 3 || i == 21)){
				i = i + 9;
			} else if ((skip == 1 && status == 3) && (i == 3 || i == 23)){
				i = i + 9;
			} else {
				i++;
			}
